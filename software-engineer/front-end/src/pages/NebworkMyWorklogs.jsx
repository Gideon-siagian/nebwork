...
import { FileText, Filter, Plus, Search, Trash2, Users2 } from "lucide-react";
...
export default function NebworkMyWorklogs() {
  ...
  const handleDeleteWorklog = async (worklogId, worklogTitle) => {
    if (!window.confirm(`Are you sure you want to delete "${worklogTitle}"? This action cannot be undone.`)) {
      return;
    }
    ...
    try {
      ...
      const response = await fetch(WORKLOG_ENDPOINTS.ONE(worklogId), {
        method: "DELETE",
        headers: {
      ...
      toast.error(deleteError.message || "Failed to delete worklog");
    } finally {
      setDeletingId(null);
    }
  };
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button 
                      ...
                      onClick={() => handleDeleteWorklog(item.id, item.title)}
